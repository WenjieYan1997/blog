...
MYSQL_PASSWORD = os.getenv('IZONE_MYSQL_PASSWORD', 'mysql')
...
ADMINS = []
admin_email_user = os.getenv('IZONE_ADMIN_EMAIL_USER','Jier0|yanwenjie1997@163.com')
if admin_email_user:
...
EMAIL_HOST_USER = os.getenv('IZONE_EMAIL_HOST_USER', 'yanwenjie1997@163.com')
EMAIL_HOST_PASSWORD = os.getenv('IZONE_EMAIL_HOST_PASSWORD', 'BTHSVBTDJRABAUOJ')  # 这个不是邮箱密码，而是授权码
...
DEFAULT_FROM_EMAIL = os.getenv('IZONE_DEFAULT_FROM_EMAIL', 'yanwenjie1997@163.com')

# 网站默认设置和上下文信息
SITE_LOGO_NAME = os.getenv('IZONE_LOGO_NAME', 'Jier0')
SITE_END_TITLE = os.getenv('IZONE_SITE_END_TITLE', 'Jier0')
SITE_DESCRIPTION = os.getenv('IZONE_SITE_DESCRIPTION', '个人博客')
SITE_KEYWORDS = os.getenv('IZONE_SITE_KEYWORDS', '个人博客')

# 个性化设置，非必要信息
# 个人 Github 地址
MY_GITHUB = os.getenv('IZONE_GITHUB', 'https://github.com/WenjieYan1997')
# 工信部备案信息
